...
--CREATE TYPE car_name AS ENUM ('AUDI','ACURA','BMW','RENAULT','CHEVROLET','GMC','HONDA','JEEP','MERCEDES','NISSAN','OPEL','PEUGEOT','SEAT','SKODA','SUBARU','VOLKSWAGEN','VOLVO');
--CREATE TYPE car_type AS ENUM ('SEDAN','HATCHBACK','CROSSOVER');
